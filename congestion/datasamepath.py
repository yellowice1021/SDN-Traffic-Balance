...
def get_total_throughout(total_throughout):
	...
	"""
	lines_list = read_file_network_stastics('./results/samepath/bwmng.txt')
...
def get_delay_values(delay_dict):
	...
	"""
	lines_list = read_file_network_delay('./results/samepath/ping.txt')
	for i in xrange(121):
...
def plot_delay(roundtrip_delay):
	...
	plt.grid(True)
	plt.savefig('./results/samepath/delay.png')
...
def plot_packet_loss(roundtrip_delay):
	...
	plt.grid(axis='y')
	plt.savefig('./results/samepath/packetloss.png')
...
def plot_flow_speed():
	...
	plt.grid(True)
	plt.savefig('./results/samepath/flowspeed.png')
...
def plot_throughout():
	...
	plt.yticks(np.linspace(0, bandwidth, 11))
	plt.grid(True)
	plt.savefig('./results/samepath/throughout.png')
