...
class NetworkAwareness(app_manager.RyuApp):
    ...
    def create_interior_links(self, link_list):
        ...
        for link in link_list:
            ...
            if str(src.dpid).startswith('2'):
                self.link_in_to[src.dpid, src.port_no] = dst.dpid
    ...
    def register_access_info(self):
        ...
        """
        dpid = [3001, 3002, 3003, 3004, 3005, 3006, 3007, 3008]
        ports = [3, 4]
        ip_number = 1
        mac_number = 1
        ...
        for switch in dpid:
            host_number = 1
            for port in ports:
                ip = '10.' + str(ip_number) + '.0.' + str(host_number)
                if mac_number < 10:
                    mac = '00:00:00:00:00:0' + str(mac_number)
                else:
                    mac = '00:00:00:00:00:' + str(mac_number)
                host_number = host_number + 1
                mac_number = mac_number + 1
                self.access_table[(switch, port)] = (str(ip), str(mac))
        ...
        #             return
        #         self.logger.info(self.access_table)
        #     else:
